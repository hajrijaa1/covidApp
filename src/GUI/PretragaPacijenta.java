...
public class PretragaPacijenta extends javax.swing.JFrame {
    Konekcija konekcija;
    /**
     * Creates new form PretragaPacijenta
     */
    public PretragaPacijenta() throws ClassNotFoundException {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pretraga po imenu, prezimenu ili vakcini");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String imeP = jTextField1.getText();
        String prezimeP = jTextField1.getText();
        ResultSet rezultat=null;   
        try {
            Konekcija konekcija=new Konekcija();
            rezultat=konekcija.pretragaPacijenta(imeP, prezimeP);
            while(rezultat.next())
            {
                String idPacijenta = rezultat.getString("id");
                int id;
                id = Integer.parseInt(idPacijenta);
                String ime=rezultat.getString("ime");
                String prezime=rezultat.getString("prezime");
                String godinaRodjenja=rezultat.getString("godiste");
                int godina;
                godina = Integer.parseInt(godinaRodjenja);
                
                String podaci[]={idPacijenta, ime, prezime, godinaRodjenja};
